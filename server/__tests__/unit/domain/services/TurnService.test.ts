...
describe('TurnService', () => {
  describe('findNextPlayer', () => {
    ...
    it('should skip players who have finished', () => {
      ...
      game.addPlayer(player2);
      game.addPlayer(player3);
      game.addFinishedPlayer('player2');
  ...
  describe('startNewRound', () => {
    ...
    it('should reset pass status for all active players', () => {
      ...
      // Assert
      const updatedPlayer1 = game.getPlayer('player1');
      const updatedPlayer2 = game.getPlayer('player2');
  ...
  describe('getSortedPlayers', () => {
    it('should sort players by rank in ascending order', () => {
      ...
      // Assert
      expect(sorted[0].id).toBe('player2'); // Rank 1
      expect(sorted[1].id).toBe('player3'); // Rank 2
      expect(sorted[2].id).toBe('player1'); // Rank 3
    });
  ...
  describe('getLastActivePlayer', () => {
    it('should return the last remaining active player', () => {
      ...
      expect(lastActive?.id).toBe('player2');
    });
